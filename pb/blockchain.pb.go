...
type Block_Header struct {
	...
	PrevBlockHash []byte `protobuf:"bytes,2,opt,name=prev_block_hash,json=prevBlockHash,proto3" json:"prev_block_hash,omitempty"` // 256-bit hash of the previous block header
	Timestamp     uint32 `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Difficulty    uint32 `protobuf:"varint,4,opt,name=difficulty,proto3" json:"difficulty,omitempty"` // number of left bit shifts to generate a 256-bit target
...
func (*Block_Header) Descriptor() ([]byte, []int) {
	return file_blockchain_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Block_Header) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
var file_blockchain_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xcf, 0x01, 0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x25, 0x0a, 0x06,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x06, 0x68, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x1a, 0x9e, 0x01, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x18,
	...
	0x01, 0x28, 0x0d, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1e,
	...
	0x6f, 0x6e, 0x63, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61,
...
var file_blockchain_proto_goTypes = []interface{}{
	(*Block)(nil),        // 0: Block
	(*Block_Header)(nil), // 1: Block.Header
}
var file_blockchain_proto_depIdxs = []int32{
	1, // 0: Block.header:type_name -> Block.Header
