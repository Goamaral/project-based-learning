...
type Block_Header_Version int32

const (
	Block_Header_VERSION_UNSPECIFIED Block_Header_Version = 0
	Block_Header_VERSION_1           Block_Header_Version = 1
)

// Enum value maps for Block_Header_Version.
var (
	Block_Header_Version_name = map[int32]string{
		0: "VERSION_UNSPECIFIED",
		1: "VERSION_1",
	}
	Block_Header_Version_value = map[string]int32{
		"VERSION_UNSPECIFIED": 0,
		"VERSION_1":           1,
	}
)

func (x Block_Header_Version) Enum() *Block_Header_Version {
	p := new(Block_Header_Version)
	*p = x
	return p
}

func (x Block_Header_Version) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Block_Header_Version) Descriptor() protoreflect.EnumDescriptor {
	return file_blockchain_proto_enumTypes[0].Descriptor()
}

func (Block_Header_Version) Type() protoreflect.EnumType {
	return &file_blockchain_proto_enumTypes[0]
}

func (x Block_Header_Version) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Block_Header_Version.Descriptor instead.
func (Block_Header_Version) EnumDescriptor() ([]byte, []int) {
	return file_blockchain_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
func (x *Blockchain) GetDifficulty() uint32 {
	if x != nil {
		return x.Difficulty
	}
	return 0
...
func (x *Blockchain) GetLastHash() []byte {
	if x != nil {
		return x.LastHash
	}
	return nil
...
type Block_Header struct {
	...
	Version       Block_Header_Version `protobuf:"varint,1,opt,name=version,proto3,enum=Block_Header_Version" json:"version,omitempty"`
...
func (*Block_Header) Descriptor() ([]byte, []int) {
	return file_blockchain_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Block_Header) GetVersion() Block_Header_Version {
	if x != nil {
		return x.Version
	}
	return Block_Header_VERSION_UNSPECIFIED
}

func (x *Block_Header) GetPrevBlockHash() []byte {
	if x != nil {
...
func (x *Block_Header) GetTimestamp() uint32 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *Block_Header) GetDifficulty() uint32 {
	if x != nil {
		return x.Difficulty
	}
	return 0
...
func (x *Block_Header) GetNonce() uint32 {
	if x != nil {
		return x.Nonce
	}
	return 0
...
var file_blockchain_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x49, 0x0a, 0x0a, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	,
	...
	0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x31, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x17, 0x0a, 0x13, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x55, 0x4e, 0x53,
	0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x56, 0x45,
	0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x31, 0x10, 0x01, 0x42, 0x0f, 0x5a, 0x0d, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_blockchain_proto_goTypes = []interface{}{
	(Block_Header_Version)(0), // 0: Block.Header.Version
	(*Blockchain)(nil),        // 1: Blockchain
	(*Block)(nil),             // 2: Block
	(*Block_Header)(nil),      // 3: Block.Header
}
var file_blockchain_proto_depIdxs = []int32{
	3, // 0: Block.header:type_name -> Block.Header
	0, // 1: Block.Header.version:type_name -> Block.Header.Version
